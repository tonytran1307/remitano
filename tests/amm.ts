...
describe("amm", async () => {
  ...
  it("Initialize AMM", async () => {
    ...
    console.log("TOKEN POOL:: "+ tokenPool.publicKey.toString());
    ...
    console.log("MOVE TOKEN:: " + mintA.publicKey.toString())
    // creating token A account
    tokenAccountA = await mintA.createAccount(authority);
    //console.log("MOVE TOKEN ACCOUNT:: " + tokenAccountA);
  ...
  it("WithdrawAllTokenTypes", async () => {
    ...
    const txHash = await program.rpc.swap(
